...
func get_basic_input():
	...
	if Input.is_action_just_pressed("seed_forward"):
		...
		print(Data.PLANT_DATA[current_seed])
...
func animate():
	if direction:
		...
		for toolAnimation in Data.TOOL_STATE_ANIMATIONS.values():
			var animation_name: String = "parameters/ToolStateMachine/" + toolAnimation + "/blend_position"
